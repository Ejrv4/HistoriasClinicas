...
<div class="container-fluid p-0">
    ...
    {{-- Pestanas de Navegacion Estilizadas --}}
            ...
            <div class="tab-pane fade show active" id="pestana-antecedentes" role="tabpanel">
                <div class="card border-0 shadow-sm p-4 rounded-4" style="background: #ffffff;">
                    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                        <h5 class="fw-bold text-dark mb-0 d-flex align-items-center"><i class="bi bi-file-earmark-medical-fill text-primary me-2fs-4"></i>Antecedentes Generales</h5>
                    ...
                    <div id="formAntecedentesContenedor">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <textarea name="Medico" class="form-control rounded-3" rows="3" placeholder="Describir antecedentes médicos..."></textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea name="Quirúrgico" class="form-control rounded-3" rows="3" placeholder="Describir intervenciones quirúrgicas..."></textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea name="Alergia" class="form-control border-danger-subtle rounded-3" rows="3" placeholder="Especificar alergias o intolerancias..."></textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea name="Medicación" class="form-control border-success-subtle rounded-3" rows="3" placeholder="Medicamentos de uso diario..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="card border-0 shadow-sm bg-white rounded-4 overflow-hidden border">
                            <div class="card-header bg-light border-bottom fw-bold font-monospace uppercase text-secondary py-2.5 px-3" style="font-size: 0.72rem; letter-spacing: 0.5px;">Referencia Histórica</div>
...
{{-- Los scripts originales e intactos permanecen aquí debajo --}}
<script>
