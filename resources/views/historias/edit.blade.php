            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-md-end">
                    <div class="d-inline-block text-start">
                        <small class="text-muted d-block small-caps">Estado</small>
                        <span class="fw-bold text-success"><i class="bi bi-pencil-square"></i> Editando Registro</span>
                    </div>
                </div>
            </div>
        </div>
...
// --- GUARDAR / ACTUALIZAR ANTECEDENTES MANUAL CON RESET DE ADVERTENCIA ---
